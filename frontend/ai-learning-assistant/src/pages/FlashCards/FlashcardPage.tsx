      ...
      try {
          ...
          setFlashcards((prevFlashcards) =>
            prevFlashcards.map((card) =>
              card._id === cardId ? {...card, iStarred: !card.isStarred } : card
            )
          );
        ...
        <div>
            <div className="mb-4">
                <Link
                    ...
                    className="inline-flex items-center gap-2 text-sm text-neautral-600 hover:text-neautral-900 transition-colors"
                >
                    <ArrowLeft size={16} />
                    Back to Document
                </Link>
            ...
            <Modal
                ...
                <div className="space-y-4">
                    <p className="text-sm text-neutral-600">
                        Are ypu sure you want to delete all the flashcards for this document?
