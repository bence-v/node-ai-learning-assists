...
const QuizManager = ({documentId}) => {
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            ...
            toast.success(`${selectedQuiz.title || 'Quiz'} was deleted.`);
    ...
    return (
        <div className="bg-white border border-neutral-200 rounded-lg p-6">
            ...
            <Modal isOpen={isDeleteModalOpen}
                   ...
                   title="Confirm Delte Quiz!"
                   >
                <div className="space-y-4">
                    <p className="text-sm text-neutral-600">
                        Are you suer you want to delete the quiz: <span className="font-semibold text-neutral-900">{selectedQuiz?.title || 'this quiz'}</span>? This action cannot be undone.
                    </p>
                    <div className="flex justify-end gap-2 pt-2">
                        <Button type="button"
                                variant="outline"
