...
const FlashcardSetCard = ({flashcardSet}) => {
    ...
    const handleStudyNow = () => {
      navigation(`/documents/${flashcardSet.documentId._id}/flashcards`)
    };
        ...
        >
            <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <p className="text-xs font-medium text-slate-500 uppercase tracking-wide">
                        Created {moment(flashcardSet.createdAt).format("YYYY-MM-DD")}
                    </p>
                </div>
            </div>
            ...
            {totalCards > 0 && (
                <div className="space-y-2">
                    ...
                    <div className="relative h-2 bg-slate-100 rounded full overflow-hidden">
                        <div
                            className="absolute inset-0 left-0 bg-linear-to-r from-emerald-500 to-teal-500 rounded-full transition-all duration-500 ease-in-out"
            ...
            <div className="mt-6 pt-4 border-t border-slate-100">
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-linear-to-r from-white/0 via-white/20 -translate-x-full group-hover/btn:translate-x-full transition-transform duration-700"></div>
                </button>
            </div>
    </div>
    );
