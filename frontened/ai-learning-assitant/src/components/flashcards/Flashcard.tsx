...
const Flashcard = ({flashcard, onToggleStar}) => {
    ...
    return (
        <div className="relative w-full h-72 group" style={{ perspective: '1000px'}}>
                ...
                >
                    ...
                    <div className="flex items-start justify-between">
                        ...
                        <button
                            ...
                            ${flashcard.isStarred ? 'bg-gradient-to-br from-amber-400 to-yellow-500 text-white shadow-lg shadow-amber-500/25'
                    ...
                    <div className="flex items-center justify-center gap-2 text-xs text-slate-400 font-medium">
                        <RotateCcw className="w-3.5 h-3.5 transition-transform duration-300 group-hover:-rotate-45" strokeWidth={2} />
