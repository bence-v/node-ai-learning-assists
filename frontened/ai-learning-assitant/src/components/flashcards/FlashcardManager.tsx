...
const FlashcardManager = ({documentId}) => {
    ...
    const handleGenerateFlashcards = async () => {
        ...
        try {
            ...
            setFlashcardSets((prev) => [...prev, response.data]);
    ...
    const handleReview = async (index) => {
        ...
        try {
            ...
            toast.success("Faslhcard reviewed!")
        } catch (error) {
                ...
                <div className="flex flex-col items-center space-y-8">
                    ...
                    <div className="flex items-center gap-6">
                        <button
                                ...
                                className="group flex items-center gap-2 px-5 h-11 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium text-sm rounded-xl transition-all duration-200disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-slate-100"
                            >
            ...
            return (
                <div className="flex flex-col items-center justify-center py-16 px-6">
                    ...
                    <p className="text-sm text-slate-500 mb-8 text-center max-w-sm">
                        Generate flashcards from your document to start learning and reainforce your knowledge.
                    </p>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs font-medium text-slate-500 uppercase tracking-wide">
                                        Created {moment(set.createAt).format("YYYY-MM-DD")}
                                    </p>
                                </div>
            ...
            <Modal
                ...
                <div className="space-y-6">
                    <p className="text-sm text-slate-600">
                      Are you sure you want to delete thi Flashcard set? This action cannot be undone and all cards will be be permanently removed.
                    </p>
