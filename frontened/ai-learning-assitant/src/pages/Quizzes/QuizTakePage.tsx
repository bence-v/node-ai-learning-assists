        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-6">
                ...
                <div className="relative h-2 bg-slate-100 rounded-full overflow-hidden">
                    <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full transition-all duration-500 ease-out"
                ...
                <div className="space-y-3">
                    {currentQuestion.options.map((option, index) => {
                        const isSelected = selectedAnswers[currentQuestion._id] === index;
                            return (
                                <label key={index}
                                       htmlFor={`option-${currentQuestion._id}-${index}`}
                                ...
                                >
                                    <input
                                        type="radio"
                                        id={`option-${currentQuestion._id}-${index}`}
