...
function QuizResultPage(props) {
    ...
    const getScoreColor = (score) => {
        ...
        if(score > 60) return 'from-emerald-500 to-orange-500';
        ...
        <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-8 mb-8">
                <div className="text-center space-y-6">
                    ...
                    {/* Stats */}
                    <div className="flex items-center justify-center ap-4 pt-4">
                        ...
                        <div className="flex items-center gap-2 px-4 py-2 bg-emerald border border-emerald-200 rounded-xl">
                            <CheckCircle2 className="w-4 h-4 text-emerald-600" strokeWidth={2} />
                            <span className="text-sm font-semibold text-emerald-700">
                                {correctAnswers} Correct
                            </span>
                        </div>
                        <div className="flex items-center gap-2 px-4 py-2 bg-rose50 border border-rose-200 rounded-xl">
                                    ...
                                    return (
                                        <div key={optIndex}
                                            ...
                                            <div className="flex items-center justify-between gap-3">
                                                <span className={`test-sm font-medium 
                                                ${isCorrectOption 
                                                    ? 'text-emerald-900'
                                                    : isWrongAnswer 
                                                        ? 'text-rose-900'
                                                ...
                                                <div className="flex items-center gap-2">
                                                    {isCorrectOption && (
                                                        <span className="inline-flex items-center gap-1 px-2 py-1 bg-emerald-100 border border-emerald-300 rounded-lg text-sx font-semibold text-emerald-700">
                                                            <CheckCircle2 className="w-3 h-3" strokeWidth={2.5} />
                                                            Correct
                                                        </span>
                                                    )}
                                                    {isWrongAnswer && (
                                                        <span className="inline-flex items-center gap-1 px-2 py-1 bg-rose-100 border borde-rose-300 rounded-lg text-xs font-semibold text-rose-700">
