    ...
    return (
        <div>
            ...
            <div className="space-y-8">
                ...
                <div className="bg-white border border-neutral-200 roundedlg p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <p className="w-full h-9 pl-9 pr-3 pt-2 border-neutral-200 rounded-lg bg-neutral-50 text-sm text-neutral-900">
                                    {email}
                                </p>
                            </div>
                        </div>
